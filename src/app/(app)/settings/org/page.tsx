  ...
  return (
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, ease: "easeOut" as const }} className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage your organization&apos;s name, logo, and company details.</p>
      </div>
      <div className="bg-card border border-border rounded-xl p-8 text-center">
        <p className="text-sm text-muted-foreground">Organization settings will be available soon.</p>
      </div>
    </motion.div>
  );
}
